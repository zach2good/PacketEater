...
#ifndef ASHITA_PacketEater_HPP_INCLUDED
#define ASHITA_PacketEater_HPP_INCLUDED
...
class PacketEater final : public IPlugin
{
    ...
    std::unique_ptr<PacketEaterCore> wrCore;

public:
    PacketEater(void);
    ~PacketEater(void) override;
...
#endif // ASHITA_PacketEater_HPP_INCLUDED
